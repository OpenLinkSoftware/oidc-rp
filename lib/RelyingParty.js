...
var RelyingParty = function (_JSONDocument) {
  ...
  _createClass(RelyingParty, [{
    ...
    key: 'get_registration',
    value: function get_registration(options, idp, oob_registration) {
      var _this4 = this;

      return Promise.resolve().then(function () {
        return _this4.registration = oob_registration.getRegistration(idp);
    ...
    key: 'register',
    value: function register(issuer, registration, options, idp_id, oob_registration) {
